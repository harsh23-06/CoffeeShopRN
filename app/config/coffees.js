...
export default [
    {
      id: 1,
      name: "Cappuccino",
      image: require("../../app/coffees/nathan-dumlao-c2Y16tC3yO8-unsplash.jpg"),
      price: "2.00",
      description:
    ...
    },
    {
      id: 2,
      name: "Espresso",
      image: require("../../app/coffees/nathan-dumlao-ikU3J1nr52w-unsplash.jpg"),
      price: "4.01",
      description:
    ...
    },
    {
      id: 3,
      name: "Latte",
      image: require("../../app/coffees/nathan-dumlao-nBJHO6wmRWw-unsplash.jpg"),
      price: "3.05",
      description:
    ...
    },
    {
      id: 4,
      name: "Flat White",
      image: require("../../app/coffees/robbie-down-LI8inyHnm_A-unsplash.jpg"),
      price: "3.00",
      description:
    ...
    },
    {
      id: 5,
      name: "Cappuccino",
      image: require("../../app/coffees/fahmi-fakhrudin-nzyzAUsbV0M-unsplash.jpg"),
      price: "4.00",
      description:
        "Cappuccino is a coffee drink made with espresso and hot milk. It is traditionally prepared with steamed milk, and is traditionally topped with a small amount of foam.",
      categoryId: 2,
    ...
    },
    {
      id: 6,
      name: "Espresso",
      image: require("../../app/coffees/taylor-franz-GJogrGZxKJE-unsplash.jpg"),
      price: "5.00",
      description:
        "Espresso is a coffee drink made with hot coffee beans that are roasted and then brewed with hot water, resulting in a strong, full-bodied, and concentrated typical of a cappuccino. It is traditionally prepared with steamed milk, and is traditionally topped with a small amount of foam.",
      categoryId: 2,
